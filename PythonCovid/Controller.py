...
class Controller(object):
    ...
    def display_list(self, number):
        ...
        if number == 0:
            for (i, item) in enumerate(self.covidList, start=1):
                print("Record:", i, ")", end=' ')
                print(item)
    ...
    Parameters
    ----------
    selected_country, id, date, cases, deaths, name_fr, name_en
    ...
    Parameters
    ----------
    deleted_country, id, date, cases, deaths, name_fr, name_en
