...
class View(object):
    ...
    """
    def main_menu(self):
        print("\nInternational COVID19 Loader - By Omar Daher\n")
        print("Main Menu, load the list by selecting option 1 before selecting any option \n"
              ...
              "7. Display Pie Chart for the # of Cases by Country \n")
        ...
        while option != 0:
            ...
            # if statement for the various inputs
            if option == 1:
